...
class DDQNAgent:
    ...
    def save_checkpoint(self, filepath, episode, max_steps=None, supervisor_state=None, run_uid=None, parent_uid=None, best_fitness=None, best_fitness_stage=None, best_avg_reward=None):
        checkpoint = {
            'episode': episode,
