...
STYLES = {
    "Standard (Curriculum)": {
        ...
        "stages": {
            1: {
                "name": "FOOD_VECTOR",
                "gamma": 0.8535340295564191,
                "food_reward": 1.0200938233934993,
                "food_shaping": 0.6573645996170017,
                "survival": 0.011266481840081565,
                "death_wall": -7.3655380202375795,
                "death_snake": -6.680093214924236,
                "wall_proximity_penalty": 0.022224101023203723,
                "max_steps": 110,
            ...
            2: {
                ...
                "gamma": 0.8,
                "food_reward": 1.0,
                "food_shaping": 0.07882202860021034,
                "survival": 0.1359188940588743,
                "survival_escalation": 0.0028464647778908897,
                "death_wall": -53.31406709932394,
                "death_snake": -34.12685370136788,
                "wall_alert_dist": 2500,
                "wall_proximity_penalty": 0.10227736913421169,
                "starvation_penalty": 0.011561559376664182,
            ...
            4: {
                ...
                "survival": 0.1160221305049382,
                "survival_escalation": 0.01,
                "death_wall": -33.82371365160069,
                "death_snake": -77.02988910525869,
                "length_bonus": 0.03312774477088247,
                "wall_proximity_penalty": 0.06108940075381541,
                "enemy_alert_dist": 3913,
                "enemy_proximity_penalty": 1.5215120934586879,
                "enemy_approach_penalty": 0.06533482611581465,
                "boost_penalty": 1.6505038840779664,
                "mass_loss_penalty": 3.564966609333511,
