...
STYLES = {
    "Standard (Curriculum)": {
        ...
        "stages": {
            1: {
                "name": "FOOD_VECTOR",
                "gamma": 0.9492763055610388,
                "food_reward": 1.0,
                "food_shaping": 1.963861534416634e-05,
                "survival": 0.015832002422526706,
                "death_wall": -32.39265616999066,
                "death_snake": -23.130786048317656,
                "wall_proximity_penalty": 0.005439218272492123,
                "max_steps": 157,
            ...
            2: {
                "name": "WALL_AVOID",
                "gamma": 0.8638631906885075,
                "food_reward": 1.1136976473063296,
                "food_shaping": 0.4129514828117929,
                "survival": 0.06468236475147943,
                "survival_escalation": 0.0005942175997928863,
                "death_wall": -49.61312807503805,
                "death_snake": -5.259468942004322,
                "wall_alert_dist": 2500,
                "wall_proximity_penalty": 0.00730036568340476,
                "starvation_penalty": 0.010567275668192107,
                "starvation_grace_steps": 19,
                "max_steps": 100,
            ...
            4: {
                ...
                "food_reward": 3.3000105348979476,
                "food_shaping": 0.10114558129725787,
                "survival": 0.004670627527139542,
                "survival_escalation": 0.0018402258481296575,
                "death_wall": -54.99420530243246,
                "death_snake": -30.39821610024035,
                "length_bonus": 0.009716526288954318,
                "wall_proximity_penalty": 0.2511992894499163,
                "enemy_alert_dist": 2470,
                "enemy_proximity_penalty": 0.0715043196495839,
                "enemy_approach_penalty": 0.006516473538040706,
                "boost_penalty": 0.02777986467068732,
                "mass_loss_penalty": 1.457522793966647,
                "starvation_penalty": 0.14276372675229423,
