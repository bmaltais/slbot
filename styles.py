...
STYLES = {
    "Standard (Curriculum)": {
        ...
        "stages": {
            1: {
                "name": "FOOD_VECTOR",
                "gamma": 0.8541059143427706,
                "food_reward": 1.4393006466832954,
                "food_shaping": 0.0035962089682480417,
                "survival": 0.014929310306884106,
                "death_wall": -9.687733600745148,
                "death_snake": -28.45887833970324,
                "wall_proximity_penalty": 0.003331264123360731,
                "max_steps": 180,
            ...
            2: {
                "name": "WALL_AVOID",
                "gamma": 0.9060753473998174,
                "food_reward": 1.0,
                "food_shaping": 0.09225352652348852,
                "survival": 0.08763296642367689,
                "survival_escalation": 0.0007147508740469132,
                "death_wall": -39.883922345853335,
                "death_snake": -62.6609138751234,
                "wall_alert_dist": 2500,
                "wall_proximity_penalty": 0.014104096892271743,
                "starvation_penalty": 0.0481230241192718,
                "starvation_grace_steps": 82,
                "max_steps": 164,
            ...
            4: {
                ...
                "gamma": 0.995,
                "food_reward": 1.887888131268192,
                "food_shaping": 0.068507378064533,
                "survival": 0.026872035986494403,
                "survival_escalation": 0.007928689904623542,
                "death_wall": -20.324421399504008,
                "death_snake": -75.57579217735955,
                "length_bonus": 0.05171609591370605,
                "wall_proximity_penalty": 0.1744592292908324,
                "enemy_alert_dist": 2132,
                "enemy_proximity_penalty": 5.0,
                "enemy_approach_penalty": 0.06780205100609565,
                "boost_penalty": 0.12134859448919197,
                "mass_loss_penalty": 7.65560352026288,
                "starvation_penalty": 0.11313568361196788,
                "starvation_grace_steps": 18,
                "max_steps": 2137,
                "promote_metric": "compound",
                "promote_conditions": {
                    "avg_steps": 600,
