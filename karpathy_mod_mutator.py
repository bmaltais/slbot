...
MUTABLE_PARAMS = {
    ...
    "boost_penalty":            (-1.0, 2.0,   0.40),
    "boost_cluster_reward":     (0.0,  2.0,   0.40),
    "boost_cluster_range":      (150,  800,   0.30),
    "boost_cluster_min_mass":   (2.0,  20.0,  0.30),
    ...
    "idle_food_penalty":        (0.0,  0.2,   0.40),
    "idle_food_range":          (100,  2000,  0.30),
    "food_lock_radius":         (0.0,  600,   0.30),
...
class Mutator:
    ...
    PARAM_GROUPS = {
        ...
        'food':     ['food_reward', 'food_shaping', 'length_bonus',
                      ...
                      'idle_food_penalty', 'idle_food_range', 'food_lock_radius',
                      'boost_cluster_reward', 'boost_cluster_range',
